<template>
  <div class="h-full w-full my-auto font-mono" style="display: grid; grid-template-columns: 50vw 50vw">
    <slider></slider>
          ...
          <div
            ...
            <div class="mt-10 px-10 pb-6">
              <form class="space-y-6" @submit.prevent="resetPassword">
                <div>
                  <div class="mt-2">
                    <input v-model="email" id="email" name="email" type="email" placeholder="Enter your email" required
                ...
                <div>
                  <button
                    ...
                    title="Reset Password" aria-label="Reset Password" @click="resetPassword()">
