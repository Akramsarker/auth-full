<template>
  ...
  >
    ...
    <div class="relative lg:w-[100%] w-[100vw]">
      ...
      >
        <div
          class="h-full flex flex-col justify-center m-auto sm:w-[450px] p-4 sm:p-0 mt-6 sm:mt-0"
        >
          <div
              ...
              <form class="space-y-6">
                ...
                <div>
                  ...
                  <div class="mt-2">
                    ...
                    <div class="text-sm mt-2 flex justify-between">
                      ...
                      <NuxtLink
                        to="/reset-password"
                        class="font-semibold text-[#2680Ec] hover:text-[#268fff]"
                        >Forgot password?
                      </NuxtLink>
                    </div>
                  </div>
                ...
                <div>
                  <p class="flex items-center mb-6">
                    ...
                    <NuxtLink
                      class="text-[#2680Ec] hover:text-[#268fff] pl-2 font-weight-medium"
                      to="/signup"
                    >
                      Sign up
                    </NuxtLink>
